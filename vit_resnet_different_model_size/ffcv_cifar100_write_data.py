...
def main(train_dataset, val_dataset):
    ...
    datasets = {
        'train': torchvision.datasets.CIFAR100('/tmp', train=True, download=True, transform=None),
        'test': torchvision.datasets.CIFAR100('/tmp', train=False, download=True, transform=None)
        }
