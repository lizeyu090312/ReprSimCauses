...
def main(train_dataset, val_dataset):
    ...
    datasets = {
        'train': torchvision.datasets.DatasetFolder(os.path.join(PATH_TO_TINYIMAGNET, "train"), 
                                                        transform=None, extensions="jpeg", 
                                                        loader=loader),
        'test': torchvision.datasets.DatasetFolder(os.path.join(PATH_TO_TINYIMAGNET, "val/images"), 
                                                        transform=None, extensions="jpeg", 
                                                        loader=loader),
        }
