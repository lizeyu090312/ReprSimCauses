...
import sys
sys.path.append("../")
from train_cifar_ffcv.ffcv_cifar100_train_task_overlap import make_dataloaders as make_dataloaders_vertical
...
def load_dl_vertical_run_metrics_ffcv_cifar100(test_indices_ood, test_indices_common,
    ...
    if len(test_indices_ood) > 0:
        tl_ood = make_dataloaders_vertical(
            None, test_indices_ood, {i:i for i in range(100)}, 
    ...
    for seed in tqdm.tqdm(range(10)):
        ...
        for p in all_dirs:
            if "slurm" not in p:
                ...
                tl_cifar100_dict = load_dl_vertical_run_metrics_ffcv_cifar100(
                ...
                tl_common = tl_cifar100_dict["tl_common"]
                tl_ood = tl_cifar100_dict["tl_ood"]
