...
#SBATCH --output=/hpc/group/wengerlab/zl310/data_overlap/combined_dataset_ffcv/partition_datagen_%j.out            # Output file name (%j expands to jobID)
#SBATCH --error=/hpc/group/wengerlab/zl310/data_overlap/combined_dataset_ffcv/partition_datagen_%j.err             # Error file name (%j expands to jobID)
...
conda activate ffcv2; cd /hpc/group/wengerlab/zl310/data_overlap/train_task_only
