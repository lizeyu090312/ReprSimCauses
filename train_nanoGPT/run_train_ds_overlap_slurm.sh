...
#SBATCH --output=/hpc/group/wengerlab/zl310/data_overlap/nanoGPT/log_dir/slurm_out/%j.out            # Output file name (%j expands to jobID)
#SBATCH --error=/hpc/group/wengerlab/zl310/data_overlap/nanoGPT/log_dir/slurm_out/%j.err             # Error file name (%j expands to jobID)
...
mkdir -p /hpc/group/wengerlab/zl310/data_overlap/nanoGPT/log_dir/slurm_out
