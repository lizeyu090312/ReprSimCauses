...
Section('data', 'data related stuff').params(
    train_dataset=Param(str, '.dat file to use for training', default="./cifar100_ffcv_data/train.beton"),
    val_dataset=Param(str, '.dat file to use for validation', default="./cifar100_ffcv_data/val.beton"),
...
def make_indices_task_test(ds_size, log_base_path, class_dict, num_classes):
    ...
    for idx, (_, label) in enumerate(torchvision.datasets.CIFAR100('/tmp', train=False, download=True)):
...
def construct_resnet(num_classes_per_split):
    ...
    # Replace with dropout + linear layer
