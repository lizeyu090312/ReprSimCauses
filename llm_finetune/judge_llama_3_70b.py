...
def main():
    ...
    ap.add_argument("--hf-token", default="my_token")
    ...
    for idx, e in enumerate(entries):
        ...
        out_csv = os.path.join(out_dir, f"llama_3_70b_judge_prompt_result.csv")
        ...
        # out_csv = os.path.join(out_dir, f"llama_3_70b_judge_prompt_rs_0_result.csv")
        ...
        # out_csv = os.path.join(out_dir, f"llama_3_70b_judge_prompt_rs_1_result.csv")
        ...
        with open(in_csv, "r", encoding="utf-8") as f_in, \
            ...
            for row in reader:
                ...
                try:
                    j_prompt, j_output = classify_once(model, tokenizer, goal, response, device)
