...
export LOG_DIR_BASE="./log_dir/task_overlap_bfloat16"

export MAX_STEPS=1000
export LOGGING_STEPS=20

# export FRAC_OVERLAP=0   # comment these out when using bash script looping through these
# export SEED=0

# ### largest
# python llm_task_overlap.py \
